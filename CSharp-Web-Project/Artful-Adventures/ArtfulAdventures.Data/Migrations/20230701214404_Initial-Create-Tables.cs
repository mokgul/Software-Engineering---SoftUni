    ...
    public partial class InitialCreateTables : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PicturesHashTags", x => new { x.PictureId, x.TagId });
                    table.ForeignKey(
                        name: "FK_PicturesHashTags_HashTags_TagId",
                        column: x => x.TagId,
                        principalTable: "HashTags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PicturesHashTags_Pictures_PictureId",
                        column: x => x.PictureId,
                        principalTable: "Pictures",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 15, "DigitalPainting" },
                    { 16, "DigitalDrawing" },
                    { 17, "DigitalIllustration" },
                    { 18, "DigitalPortrait" },
                    { 19, "DigitalSketching" },
                    { 20, "EnvironmentalDesign" },
                    { 21, "FanArt" },
                    { 22, "Fantasy" },
                    { 23, "GameArt" },
                    { 24, "Graffiti" },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PicturesHashTags_TagId",
                table: "PicturesHashTags",
                column: "TagId");
        }
